...
const env = {
  ...
  paymentGatewayDefault: (process.env.PAYMENT_GATEWAY_DEFAULT || 'MANUAL').toUpperCase(),
  publicAppBaseUrl: process.env.PUBLIC_APP_BASE_URL || null,
  referralRewardMinor: parseIntEnv(process.env.DEFAULT_REFERRAL_REWARD_MINOR, 50000),
  couponReferralWelcomeMinor: parseIntEnv(process.env.DEFAULT_REFERRAL_WELCOME_COUPON_MINOR, 25000),
  paytmEnvironment: (process.env.PAYTM_ENVIRONMENT || 'STAGING').toUpperCase(),
  paytmMid: process.env.PAYTM_MID || null,
  paytmMerchantKey: process.env.PAYTM_MERCHANT_KEY || null,
  paytmWebsite: process.env.PAYTM_WEBSITE || null,
  paytmCallbackUrl: process.env.PAYTM_CALLBACK_URL || null,
  paytmClientId: process.env.PAYTM_CLIENT_ID || null,
